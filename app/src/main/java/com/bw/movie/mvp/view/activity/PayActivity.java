...
import com.bw.movie.util.Constant;
...
//                        Toast.makeText(PayActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 将该app注册到微信
        api.registerApp(Constant.APP_ID);//wxb3852e6a6b7d9516
//        totalPrice = getIntent().getFloatExtra("totalPrice", 0);
        ...
        payTotalPrice.setText("需支付：" + totalPrice + "元");
        payPay.setText("支付宝支付" + totalPrice + "元");
    }

    @OnClick({R.id.pay_wx, R.id.pay_ali, R.id.pay_pay})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.pay_wx:
                payType = 1;
                payPay.setText("微信支付" + totalPrice + "元");
                break;
            case R.id.pay_ali:
                payType = 2;
                payPay.setText("支付宝支付" + totalPrice + "元");
    ...
    private void wechatPay(String orderId) {
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                Log.i("aaa", "PayActivity onResponse:" + json.toString());
